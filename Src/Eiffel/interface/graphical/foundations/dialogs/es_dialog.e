...
--	       				end
       				dialog.set_size (development_window.scaled_size (l_sp_info.width), development_window.scaled_size (l_sp_info.height))
       			end
...
feature {NONE} -- User interface initialization
	...
	frozen build_interface
		...
		do
			...
			create l_container
			l_container.set_border_width (development_window.scaled_size (dialog_border_width))
			l_main_container.extend (l_container)
			build_dialog_interface (l_container)

 			create l_container
			l_container.set_border_width (development_window.scaled_size (dialog_button_border_width))
			l_main_container.extend (l_container)
