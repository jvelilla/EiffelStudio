...
feature{NONE} -- Initialization
	...
	initialization (a_tool: EB_DEVELOPMENT_WINDOW)
		...
		do
			...
			l_ev_empty_lbl.set_minimum_height (develop_window.scaled_size (State_bar_height))
			l_ev_empty_lbl.set_minimum_width (develop_window.scaled_size (State_bar_height) * 2)
			...
			create l_cell
			l_cell.set_minimum_width (develop_window.scaled_size (5))
			...
			locale_combo.set_minimum_width (develop_window.scaled_size (200))
			l_ev_horizontal_box_2.disable_item_expand (locale_combo)
			l_ev_horizontal_box_2.set_padding_width (develop_window.scaled_size (5))
			...
			l_ev_vertical_box_1.set_padding (develop_window.scaled_size (4))
			l_ev_vertical_box_1.set_border_width (develop_window.scaled_size (4))
