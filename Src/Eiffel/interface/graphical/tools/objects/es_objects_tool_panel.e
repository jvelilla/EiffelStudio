	...
	create_objects_grid (a_name: STRING_GENERAL; a_id: STRING)
		...
		do
			...
			g.set_default_columns_layout (
						<<
							[g.col_name_id, 	True,  False, develop_window.scaled_size (150), interface_names.l_name, interface_names.to_name],
							[g.col_value_id, 	True,  False, develop_window.scaled_size (150), interface_names.l_value, interface_names.to_value],
							[g.col_type_id, 	True,  False, develop_window.scaled_size (200), interface_names.l_type, interface_names.to_type],
							[g.col_address_id, 	True,  False, develop_window.scaled_size  (80), interface_names.l_address, interface_names.to_address],
							[g.col_scoop_pid_id, True, False, develop_window.scaled_size  (30), interface_names.l_scoop_pid, interface_names.to_scoop_pid],
